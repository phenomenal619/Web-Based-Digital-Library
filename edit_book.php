...

{
  ...
  {  
	...
	else
	{
      ...
      $sql="UPDATE book SET". "booksname ='$bookname',"."authorname = '$authorname',"."section = '$section',"."file_name = '$new_file_name',"."path = '$fpath'". " WHERE book.b_id ="."'$id'";
...
<body>
  <div class="box">
   <table  style ="border-color:red; font-size:16pt"  align="center" width="100%" height="100%">
      <tr>
        <td style="color:blue"><h1 align="center"><marquee>Welcome To ethiotelecom online Library System</marquee></h1></td>
      </tr>
      <tr>
        <td style="color:blue" align="center"><b><i>Edit books in the Database</i></b></td>
      </tr>
    </table>
  </div>
<div class="nav">
...
<div class = "header">
  ...
  <option value="fraud managment">Fraud Managment</option>
  <option value="revenue authority">Revenue Authority</option>
