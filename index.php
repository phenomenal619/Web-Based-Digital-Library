...
{  
   $count=0;
   $data=mysqli_query($conn,"select * from employee_registration where emailid='$_POST[username]' && password='$_POST[password]'");
...
<body>
  <div class="box">
   <table  style =" font-size:16pt"  align="center" width="100%" height="100%" >
      <tr>
        <td style="color:blue"><h1 align="center"><marquee><u>Welcome To ethiotelecom online Library System</u></marquee></td></h1>
      </tr>
      <tr>
