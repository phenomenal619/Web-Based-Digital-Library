...

{
  ...
  $_SESSION["semail"]=$email;
   ...
   if($name!="" && $roll!="" && $section!=""  && $email!="" && $password!="" )
         { 
           $insert="INSERT INTO employee_registration(roll,gender,name,section,emailid,password) VALUES('".$roll."','".$gender."','".$name."','".$section."','".$email."','".$password."')";
